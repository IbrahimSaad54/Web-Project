...
## 📝 Description  
This project showcases a **multi-page educational website** that works perfectly across all devices — desktop, tablet, and mobile.  
It includes essential sections such as:  
- Home Page  
- Services Page
- Courses Page
- Categories Page
...
- **Modern Layout:** Clean and attractive interface suitable for e-learning.  
- **Interactive Navigation:** Mobile menu toggle using JavaScript.  
- **Easy to Customize:** Simple HTML/CSS structure for quick edits or redesign.  
- **Beginner-Friendly:** Perfect for web development learners who want a real project to practice with.  
